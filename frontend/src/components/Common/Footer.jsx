...
const Footer = () => {
  return (
    <div className='max-w-screen h-[850px] md:h-[370px]  bg-white footer border border-b-0  border-t-gray-200' >
      <div className='grid grid-cols-1 md:grid-cols-4 px-10 py-3 pt-10' >
