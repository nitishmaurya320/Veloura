    ...
    <div className='max-w-screen mx-auto md:pt-2  md:p-8 '>
        {selectedProduct&&(
            ...
            <div className='flex-col-reverse flex  md:flex-row mx-auto  md:mx-0 md:w-[40%] ml-0 mr-0 w-full  md:space-y-4  md:gap-2 mt-5 md:mt-0'>
                ...
                <div className='w-full border-blue-600  h-full'>
                        <img className='rounded-lg h-full object-cover' src={selectedProduct.product.images[`${currentProduct}`]?.url} alt="Main product    "/>
                 </div>
